...
const catalog: CatalogEntry[] = [
  ...
  { name: "Steamed Fish Lunch Box", category: "Lunch Boxes", price: 2600, description: "Whole fish steamed with herbs, peppers and garden vegetables." },
  { name: "Soup", category: "Starters", price: 500, description: "A comforting bowl of today's freshly prepared soup." },
  ...
  { name: "Jerk Pork", category: "Mains", price: 1000, description: "Tender pork seasoned with our bold jerk spices." },
  { name: "Fish", category: "Mains", price: 2500, description: "Freshly prepared fish in your choice of size.", showsStartingPrice: true, optionGroup: "Choose your fish size" },
  { name: "Rice & Peas Meal", category: "Mains", price: 1500, description: "A hearty meal built around seasoned rice and peas." },
  { name: "Callaloo", category: "Sides", price: 700, description: "Tender greens cooked with fresh vegetables and island seasoning." },
  { name: "Fried Dumplings", category: "Sides", price: 600, description: "Golden, crisp outside and soft inside. Three per order." },
  ...
  { name: "Fried Plantain", category: "Sides", price: 500, description: "Sweet ripe plantain fried until caramelized." },
  { name: "Strawberry Pineapple", category: "Natural Drinks", price: 1000, description: "A refreshing natural strawberry and pineapple drink." },
  { name: "To The World", category: "Natural Drinks", price: 1000, description: "The house natural drink blend featured on our menu." },
  { name: "Beetroot", category: "Natural Drinks", price: 1000, description: "A vibrant natural beetroot drink." },
  { name: "Irish Moss", category: "Natural Drinks", price: 1000, description: "A rich, creamy Caribbean-style Irish moss drink." },
  { name: "Cucumber", category: "Natural Drinks", price: 1000, description: "A cool and refreshing natural cucumber drink." },
  { name: "Carrot", category: "Natural Drinks", price: 1000, description: "A smooth natural carrot drink with island flavor." },
  { name: "Other Natural Drink", category: "Natural Drinks", price: 1000, description: "Ask about today's additional natural drink flavor." },
