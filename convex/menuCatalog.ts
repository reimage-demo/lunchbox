...
const catalog: CatalogEntry[] = [
  ...
  { name: "Steamed Fish Lunch Box", category: "Lunch Boxes", price: 2600, description: "Whole fish steamed with herbs, peppers and garden vegetables.", imageUrl: publicImageUrl("5423.webp") },
  { name: "Soup", category: "Starters", price: 500, description: "A comforting bowl of today's freshly prepared soup.", imageUrl: publicImageUrl("menu-soup.webp") },
  ...
  { name: "Jerk Pork", category: "Mains", price: 1000, description: "Tender pork seasoned with our bold jerk spices.", imageUrl: publicImageUrl("menu-jerk-pork.webp") },
  { name: "Fish", category: "Mains", price: 2500, description: "Freshly prepared fish in your choice of size.", imageUrl: publicImageUrl("4575.webp"), showsStartingPrice: true, optionGroup: "Choose your fish size" },
  { name: "Rice & Peas Meal", category: "Mains", price: 1500, description: "A hearty meal built around seasoned rice and peas.", imageUrl: publicImageUrl("menu-rice-and-peas.webp") },
  { name: "Callaloo", category: "Sides", price: 700, description: "Tender greens cooked with fresh vegetables and island seasoning.", imageUrl: publicImageUrl("4118.webp") },
  { name: "Fried Dumplings", category: "Sides", price: 600, description: "Golden, crisp outside and soft inside. Three per order.", imageUrl: publicImageUrl("4120.webp") },
  { name: "Festival", category: "Sides", price: 500, description: "Sweet Jamaican fried dough with a golden outside and soft center.", imageUrl: publicImageUrl("menu-festival.webp") },
  { name: "Fried Plantain", category: "Sides", price: 500, description: "Sweet ripe plantain fried until caramelized.", imageUrl: publicImageUrl("menu-fried-plantain.webp") },
  { name: "Strawberry Pineapple", category: "Natural Drinks", price: 1000, description: "A refreshing natural strawberry and pineapple drink.", imageUrl: publicImageUrl("drink-strawberry-pineapple.webp") },
  { name: "To The World", category: "Natural Drinks", price: 1000, description: "The house natural drink blend featured on our menu.", imageUrl: publicImageUrl("drink-to-the-world.webp") },
  { name: "Beetroot", category: "Natural Drinks", price: 1000, description: "A vibrant natural beetroot drink.", imageUrl: publicImageUrl("drink-beetroot.webp") },
  { name: "Irish Moss", category: "Natural Drinks", price: 1000, description: "A rich, creamy Caribbean-style Irish moss drink.", imageUrl: publicImageUrl("drink-irish-moss.webp") },
  { name: "Cucumber", category: "Natural Drinks", price: 1000, description: "A cool and refreshing natural cucumber drink.", imageUrl: publicImageUrl("drink-cucumber.webp") },
  { name: "Carrot", category: "Natural Drinks", price: 1000, description: "A smooth natural carrot drink with island flavor.", imageUrl: publicImageUrl("drink-carrot.webp") },
  { name: "Other Natural Drink", category: "Natural Drinks", price: 1000, description: "Ask about today's additional natural drink flavor.", imageUrl: publicImageUrl("drink-other-natural.webp") },
